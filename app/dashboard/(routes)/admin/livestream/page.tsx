    ...
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Button onClick={() => router.push("/dashboard/admin/livestream/create")} className="bg-brand hover:bg-brand/90 text-white">
                            ...
                            <TableBody>
                                {filteredLivestreams.map((session) => (
                                    <TableRow key={session.id}>
                                        ...
                                        <TableCell>
                                            {session.courses[0]?.user?.fullName || "-"}
                                        </TableCell>
                                        <TableCell>
                                        ...
                                        <TableCell>
                                            <div className="flex items-center space-x-2">
                                                <Button
                                                    size="sm"
                                                    variant="outline"
                                                    onClick={() => router.push(`/dashboard/admin/livestream/${session.id}/edit`)}
                                                >
